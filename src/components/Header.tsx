...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-brand-400 px-4 py-3">
      <nav className="max-w-7xl mx-auto bg-card rounded-full px-4 md:px-8 py-3 shadow-lg flex items-center justify-between">
        {/* Logo */}
      ...
      >
        ...
        <div className="mt-6">
          <Button variant="hero" className="rounded-full px-6 w-full">
            <User className="w-4 h-4 mr-2" />
            Criar conta
          </Button>
        </div>
